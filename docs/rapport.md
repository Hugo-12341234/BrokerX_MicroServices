...
- [Priorisation MoSCoW des cas d'utilisation](#priorisation-moscow-des-cas-dutilisation)
  - [1.7 Description détaillée des cas d’utilisation (DDD)](#17-description-détaillée-des-cas-dutilisation-ddd)
    ...
    - [UC-04 — Abonnement aux données de marché](#uc-04--abonnement-aux-données-de-marché)
    ...
    - [UC-06 — Modification / Annulation d’un ordre](#uc-06--modification--annulation-dun-ordre)
    - [UC-07 — Appariement interne \& Exécution (matching)](#uc-07--appariement-interne--exécution-matching)
    - [UC-08 — Confirmation d’exécution \& Notifications](#uc-08--confirmation-dexécution--notifications)
  ...
  - [9. Vue Processus (C\&C)](#9-vue-processus-cc)
    - [Diagrammes](#diagrammes)
      ...
      - [UC04 — Séquence](#uc04--séquence)
      - [UC04 — Activité](#uc04--activité)
      - [UC05 — Séquence](#uc05--séquence)
      - [UC05 — Activité](#uc05--activité)
      - [UC06 — Séquence](#uc06--séquence)
      - [UC06 — Activité](#uc06--activité)
      - [UC07 — Séquence](#uc07--séquence)
      - [UC07 — Activité](#uc07--activité)
      - [UC08 — Séquence](#uc08--séquence)
      - [UC08 — Activité](#uc08--activité)
    - [Contexte](#contexte-3)
    - [Éléments](#éléments-3)
  ...
  - [11. Concepts transversaux](#11-concepts-transversaux)
    ...
    - [11.2 Diagrammes de classes par microservice](#112-diagrammes-de-classes-par-microservice)
      ...
      - [Market-Data-Service](#market-data-service-1)
    ...
    - [11.9 Communication inter-microservices](#119-communication-inter-microservices)
...
- [ADR 006 : Choix de l’API Gateway](#adr-006--choix-de-lapi-gateway)
  ...
  - [12.7 Justification du choix de message broker](#127-justification-du-choix-de-message-broker)
- [ADR 007 : Choix du message broker](#adr-007--choix-du-message-broker)
  - [Contexte](#contexte-11)
  - [Décision](#décision-6)
  - [Conséquences](#conséquences-6)
  - [12.8 Justification du choix de base de données](#128-justification-du-choix-de-base-de-données)
- [ADR 008 : Choix de la base de données](#adr-008--choix-de-la-base-de-données)
  - [Contexte](#contexte-12)
  - [Décision](#décision-7)
  - [Conséquences](#conséquences-7)
  - [12.9 Justification du choix de pattern Saga](#129-justification-du-choix-de-pattern-saga)
- [ADR 009 : Pattern Saga chorégraphiée vs orchestrée](#adr-009--pattern-saga-chorégraphiée-vs-orchestrée)
  - [Contexte](#contexte-13)
  - [Décision](#décision-8)
  - [Conséquences](#conséquences-8)
  - [12.10 Justification de l’architecture interne des microservices](#1210-justification-de-larchitecture-interne-des-microservices)
- [ADR 010 : Architecture interne des microservices - Hexagonale vs MVC](#adr-010--architecture-interne-des-microservices---hexagonale-vs-mvc)
  - [Contexte](#contexte-14)
  - [Décision](#décision-9)
  - [Conséquences](#conséquences-9)
...
- [Fin de la documentation arc42](#fin-de-la-documentation-arc42)
  - [Analyse de performance — Impact de la cache sur le service `wallet-service`](#analyse-de-performance--impact-de-la-cache-sur-le-service-wallet-service)
    - [Contexte](#contexte-15)
    - [Résultats](#résultats)
      - [1. Sans cache](#1-sans-cache)
      - [2. Avec cache](#2-avec-cache)
    - [Comparaison](#comparaison)
    - [Conclusion](#conclusion)
  - [Test de charge — Service des ordres (architecture microservices avec gateway)](#test-de-charge--service-des-ordres-architecture-microservices-avec-gateway)
    - [Contexte](#contexte-16)
  ...
  - [Test de charge — Appels direct avec architecture monolithique (A/B direct)](#test-de-charge--appels-direct-avec-architecture-monolithique-ab-direct)
  ...
  - [Test de charge — Architecture event-driven avec message broker (RabbitMQ)](#test-de-charge--architecture-event-driven-avec-message-broker-rabbitmq)
    - [Contexte](#contexte-18)
    - [Résultats observés](#résultats-observés-2)
      - [Grafana — Monitoring en temps réel](#grafana--monitoring-en-temps-réel-2)
      - [Résumé du test K6](#résumé-du-test-k6-2)
    - [Analyse](#analyse)
    - [Conclusion](#conclusion-2)
  - [Comparaison — Microservices (Gateway) vs Monolithique (A/B direct) vs Event-driven (RabbitMQ)](#comparaison--microservices-gateway-vs-monolithique-ab-direct-vs-event-driven-rabbitmq)
    - [Analyse](#analyse-1)
  - [Test de charge — Évaluation du load balancer (NGINX)](#test-de-charge--évaluation-du-load-balancer-nginx)
    - [Contexte](#contexte-19)
...
- [Guide d'exploitation (Runbook)](#guide-dexploitation-runbook)
  ...
  - [13. Pour utiliser le script de déploiement (Optionnel)](#13-pour-utiliser-le-script-de-déploiement-optionnel)
    - [Exécution du script sur Windows](#exécution-du-script-sur-windows)
- [Guide de démonstration BrokerX](#guide-de-démonstration-brokerx)
  ...
  - [4. Abonnement aux données de marché (UC-04)](#4-abonnement-aux-données-de-marché-uc-04)
  - [5. Placement d’un ordre (UC-05)](#5-placement-dun-ordre-uc-05)
  - [6. Modification / Annulation d’un ordre (UC-06)](#6-modification--annulation-dun-ordre-uc-06)
  - [7. Appariement d’un ordre (UC-07)](#7-appariement-dun-ordre-uc-07)
  - [8. Confirmation d'exécution \& Notifications (UC-08)](#8-confirmation-dexécution--notifications-uc-08)
